...
// ==========================================
//   COLECCIÓN: GRUPOS
//   CAMBIO: anio_lectivo → año_lectivo
//           id_director_grupo → director_grupo
// ==========================================
  ...
  validator: {
    $jsonSchema: {
      ...
      properties: {
        ...
        director_grupo: { bsonType: "objectId" },
        director_info: {
          bsonType: "object",
          properties: {
            nombres: { bsonType: "string" },
...
// ==========================================
//   COLECCIÓN: HORARIOS
//   CAMBIO: Validador eliminado — dos servicios usan formatos distintos:
//     - students_service lee: { grupo(str), año_lectivo, horario[] }
//     - groups_service escribe: { id_grupo(ObjectId), año_lectivo, bloques[], activo }
//   Ambos índices creados para soportar las dos formas de búsqueda.
// ==========================================
db.createCollection("horarios");

db.horarios.createIndex({ grupo: 1, año_lectivo: 1 });
...
//   CAMBIO: calificaciones items ya no tienen "required" estricto.
//     - students_service usa estructura anidada: { id_asignacion, periodo, notas[] }
//     - grades_service y teachers_service empujan notas planas: { tipo, nota, peso, ... }
//   Se relaja el validador para permitir ambas formas.
// ==========================================
...
//   CAMBIO: id_asignacion → id_curso
//   teachers_service registra asistencia por curso, no por asignación.
// ==========================================
...
grupos.forEach(g => {
  ...
  const id = db.grupos.insertOne({
    ...
    jornada: g.jornada,
    año_lectivo: "2025",
    director_grupo: docentesIds[g.director],
    director_info: {
